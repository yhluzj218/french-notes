...
- [08_ai/audio/](08_ai/audio/) — 音檔練習腳本（`dialogues/` 對話聽力、`shadowing/` 跟讀、`chants/` 記憶 chant）
...
| `產生本週對話` | 用近期收錄的單字/句型產生對話聽力腳本 |
| `產生 shadowing` | 產生單句跟讀腳本 |
| `產生 chant` | 產生記憶 chant（文字稿 + Suno prompt） |
