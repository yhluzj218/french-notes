...
### ③b 《Les 500 exercices de phonétique》A1/A2（CLE 出版）— 系統化音素練習
- 紙本練習冊 + 音檔，逐音攻克，比隨機影片更有結構
- 來源：一位中文母語學習者（一年到 C1）分享她開頭一個月就用這本做密集發音練習，路線與 Phase 1 相同
- 用法：每天挑 1–2 個練習，取代或補充第 ①③ 步的素材（需先購入）
...
| 日期 | 音組 | 練習詞 |
|---|---|---|
| 週日 7/12 | [u] vs [y] | tout/tu、vous/vu、roue/rue |
| 週一 7/13 | [e] vs [ɛ] | décidé/décider、blé/belge、chez/très |
| 週二 7/14 | [o] vs [ɔ] + [ø] | chaud/ombre、deux/doux |
| 週三 7/15 | 鼻母音三分 [ɛ̃]/[ɑ̃]/[ɔ̃] | demain/enfant/ombre、lundi/bande/longue |
| 週四 7/16 | 全部複習 + 自測 | 混合隨機 10 題 ×3 輪；補充：線上課程 1-2 母音類型（工具⑤） |
| 週五 7/17 | 總自測 + 複習清單收尾 | 見 [lesson-01 複習清單](../01_lessons/2026-07-11_lesson-01.md)；預習：線上課程 1-3 特殊子音 |
| 週六 7/18 | 上課（子音） | 課堂驗證 |
